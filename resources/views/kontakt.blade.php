...
@section('content')
    ...
    <section class="m-4">
        ...
        <!--Section description-->
        <p class="text-center w-responsive mx-auto mb-5">Soe haben eine Frage? Bitte zögern Sie nicht diese zu stellen.
